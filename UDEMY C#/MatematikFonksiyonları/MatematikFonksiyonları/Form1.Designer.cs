namespace MatematikFonksiyonları
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(308, 64);
			...
			this.button2.Text = "Üste Yuvarla";
			...
			this.button3.Text = "Alta Yuvarla";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(448, 238);
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(585, 238);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(120, 74);
			this.button5.TabIndex = 7;
			this.button5.Text = "Karekök";
